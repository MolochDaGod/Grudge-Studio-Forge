  ...
  return (
    <div className="rounded-md border border-border bg-card/50 p-2 space-y-3 text-[11px]">
      <p className="text-muted-foreground leading-snug">
        Orchestrator picks the best <strong className="text-foreground">allowed</strong>{" "}
        provider. Add a system prompt to steer every agent. Ollama options improve offline
        coding without the cloud.
      </p>
